      ...
      <div style={{
        ...
        <div style={{width:"100%", maxWidth:380}}>
          ...
          <button
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(201,168,76,0.45)"; (e.currentTarget as HTMLElement).style.background = "rgba(201,168,76,0.04)" }}
